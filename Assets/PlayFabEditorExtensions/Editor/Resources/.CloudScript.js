...
handlers.Test = function (args, context) {
    var playerStats = server.GetPlayerStatistics({ 
     ...
     var moves = { StatisticName: "RubbishCollected", Value: 1 };
     for (i = 0; i < playerStats.length; ++i) 
     {
        if (playerStats[i].StatisticName === "RubbishCollected") 
        {
...
handlers.GetWorldLeaderboardByCountries = function (args, context){
    
    var keys;
    for (var i = 0; i < args.playersIds.length; i++) {
        keys[i] = server.GetUserInternalData({ PlayFabId: args.playersIds[i] }).Keys;
    }
    
    var countries;
    for (var i = 0; i < keys.length; i++) {
        countries[i] = keys[i].Value;
    }
    
    return args.playersIds[0];
};
...
handlers.UpdatePlayerStats = function (args, context) {
    var request = {
        PlayFabId: currentPlayerId, Statistics: [{
                StatisticName: "ProgressLevel",
                Value: args.cloudProgressLevel
            },                                  
            {
                StatisticName: "RubbishCollected",
                Value: args.cloudRubbishCollected
            },                                  
            {
                StatisticName: "CoinsAvailable",
                Value: args.cloudCoinsAvailable
            },
            {
                StatisticName: "RecycleCollected",
                Value: args.cloudRecycleCollected
            },
            {
                StatisticName: "WasteCollected",
                Value: args.cloudWasteCollected
            },
            {
                StatisticName: args.cloudStatisticNamePlace,
                Value: args.cloudRubbishCollectedInPlace
            },                                  
            {
                StatisticName: args.cloudStatisticNameDistrict,
                Value: args.cloudRubbishCollectedInDistrict
            },                                  
            {
                StatisticName: args.cloudStatisticNameRegion,
                Value: args.cloudRubbishCollectedInRegion
            },                                  
            {
                StatisticName: args.cloudStatisticNameCountry,
                Value: args.cloudRubbishCollectedInCountry
            }]
    };
    var playerStatResult = server.UpdatePlayerStatistics(request);
    return{ messageValue : "Cloud stats Updated"}
};
handlers.UpdatePlayerCoins = function (args, context) {
    var request = {
        PlayFabId: currentPlayerId, Statistics: [{
                StatisticName: "CoinsAvailable",
                Value: args.cloudCoinsAvailable
    ...
    var playerStatResult = server.UpdatePlayerStatistics(request);
    return{ messageValue : "Coin stats Updated"}
};
handlers.UpdateMonstersKilled = function (args, context) {
    var request = {
        PlayFabId: currentPlayerId, Statistics: [{
                StatisticName: "MonstersKilled",
                Value: args.cloudMonstersKilled
            }]
    };
    var playerStatResult = server.UpdatePlayerStatistics(request);
    return{ messageValue : "Monster stats Updated"}
};
