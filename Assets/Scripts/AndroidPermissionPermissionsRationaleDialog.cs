...
public class AndroidPermissionPermissionsRationaleDialog : MonoBehaviour
{
    ...
    {
        GUI.Label(new Rect(10, 20, kDialogWidth - 20, kDialogHeight - 50), "This is a location-based app. Let it use your location.");
